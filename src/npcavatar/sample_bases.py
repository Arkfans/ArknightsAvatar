...
DEFAULT_OUTPUT_DIR = "data/unpacked/bases_sample"
...
def main(argv: list[str] | None = None) -> int:
    ...
    characters_dir = Path(args.characters_dir or report.get("characters_dir") or "data/unpacked/characters")
