...
detected via the extract report (``data/unpacked/_avatar_extract.json``) and
...
CLI: ``npcavatar-collage``. Only depends on Pillow.
"""
...
DEFAULT_OUTPUT_DIR = "data/unpacked/_diff_collage"
DEFAULT_EXTRACT_REPORT = "data/unpacked/_avatar_extract.json"
TILE_SIZE = 180
PADDING = 5
DEFAULT_COLUMNS = 3
FONT_SIZE = 15
