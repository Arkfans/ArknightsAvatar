...
DEFAULT_AVATARS_DIR = "data/unpacked/avatars"
DEFAULT_MANUAL = "data/unpacked/_avatar_manual.json"
DEFAULT_DERIVE_MODEL = "data/avatar_derive_08/model.json"
DEFAULT_FACE_HEAD_CACHE = "data/unpacked/_face_head_detect.json"
DEFAULT_EXTRACT_CACHE = "data/unpacked/_avatar_extract_cache.json"
DEFAULT_OUTPUT_DIR = "data/export"
...
def load_derive_model(path: str | Path) -> dict:
    """Load the face/head -> avatar box derivation model (avatar_derive_08)."""
...
def derive_box(model: dict, face_pos: dict, head_pos: dict) -> list[int]:
    ...
    Features follow ``data/avatar_derive_08/model.json``: face/head box centers
...
def detect_face_head_image(
    ...
    *,
    ...
    tmp = tmp_dir / f".npcavatar_tmp_{stem}.png"
    try:
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--derive-model", default=DEFAULT_DERIVE_MODEL, help="avatar_derive_08 model JSON")
