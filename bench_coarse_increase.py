"""Benchmark COARSE_INCREASE 1..5 on npcavatar-match --limit 50.
...
from npcavatar.match import match_characters
...
def main() -> int:
    ...
    summary.write_text(
        json.dumps(
            {"command": f"uv run npcavatar-match --limit {args.limit}", "runs": rows},
            ensure_ascii=False,
            indent=2,
        ),
        encoding="utf8",
